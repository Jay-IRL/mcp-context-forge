...
* `uvicorn mcpgateway.main:app --host 0.0.0.0 --port 4444 --workers 2` will start Context forge UI and APIs at http://localhost:4444/docs and toolops API endpoints will be shown.
